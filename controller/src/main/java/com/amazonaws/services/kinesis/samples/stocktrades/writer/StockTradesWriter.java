...
public class StockTradesWriter {
    ...
    private static void sendStockTrade(StockTrade trade, KinesisAsyncClient kinesisClient, String streamName) {
        ...
        int x = random.nextInt(3) + 1;  // Generates a random number between 1 and 3
        int y = random.nextInt(3) + 1;
        int z = random.nextInt(3) + 1;
        // Put the random values into the JSON object
        ...
        PutRecordRequest request = PutRecordRequest.builder()
                ...
                .data(SdkBytes.fromByteArray(jsonObject.toString().getBytes()))
                .build();
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String streamName = "TestTradeStream";
